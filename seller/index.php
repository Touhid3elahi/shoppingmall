...
date_default_timezone_set('Asia/Dacca');// change according timezone
            ...
            <div class="card-body">
              ...
              {?>
                  <div class="alert alert-error">
                    <button type="button" class="btn btn-danger btn-circle" data-dismiss="alert"><i class="fas fa-trash"></i></button>
...
?>
  <tr>
                      ...
                      <td>
                      <a href="edit-products.php?id=<?php echo $row['id']?>"class="btn btn-info btn-circle btn-sm" ><i class="far fa-edit"></i></a>
                      <a href="index.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a></td>
                    </tr>
                    <?php $cnt=$cnt+1; } ?>
                  </tbody>
                </table>
